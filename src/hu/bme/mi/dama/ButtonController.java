...
public class ButtonController {
	...
	/**
	 * Függvény, ami lekezel egy lépést és a lépés hatására felmerülő jelzéseket
	 * 
	 * @param from
	 *            Lépés innen
	 * @param to
	...
	public void controllClick2(BoardButton b) {
		if (status == GameEvents.KEEPGOING) {
			// Hanyadik kattintás, volt már előtte egy?
			if (bPrev == null) {
				// Az első kattintás csak kijelöl
				...
				// Ha volt már kijelölt első kattintás
				if (b.equals(bPrev)) {
